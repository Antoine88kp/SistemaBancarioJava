...
Asignatura: Programación Orientada a Objetos Tema: Clases Abstractas, Interfaces, Excepciones, Herencia y Polimorfismo
...
Diagrama de Clases (PNG, JPG o .puml) en la carpeta /docs — debe incluir interfaces, excepciones y enums
...
Crea un repositorio privado en GitHub haciendo fork al repositorio de la asignatura
Sube el código respetando la estructura de paquetes indicada
Incluye los diagramas en la carpeta /docs
Mantén este archivo README.md actualizado con tus datos y el estado de la lista de verificación
Comparte el enlace al repositorio antes de la fecha límite
